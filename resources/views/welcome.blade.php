...
{{--            <button type="button" class=" btn btn-success" onclick="pay()">payment</button>--}}
{{--        </div>--}}
{{--        <div id="yourContainer">--}}

{{--        </div>--}}
<form action="{{url('payment-process')}}" id="stripe" method="post">
...
<script>
    function pay() {
        ...
        $.ajax({
            ...
            iframe.src        = msg.next_action?.redirect_to_url?.url;
            iframe.width      = 600;
            iframe.height     = 400;
